...
const CHARACTERS = [
  ...
  },
  {
    ...
    playstyle: 'Calculated Authority',
    trait: 'Unshakably composed',
    skills: [
      'Reads opponents before they even play',
      'Controls board tempo at will',
      'Punishes hesitation without mercy',
      'Decades of table experience behind every move',
    ],
    specialAbility: {
      name: 'El Jefe',
      description: "Manny's presence alone shifts the psychological weight of the table. Opponents start second-guessing moves they already knew were correct.",
    },
    weakness: 'Can show mercy to family — a rare and exploitable moment.',
    quote: "I've seen this before. Fifty years ago.",
    bio: "Manny has been playing Cuban Double-Nine since before most players were born. Every move is deliberate, every silence intentional. He doesn't need to intimidate — the history behind his eyes does it for him. Beating Manny is a story you tell for years.",
    aiStrategy: 'expert',
  },
];
